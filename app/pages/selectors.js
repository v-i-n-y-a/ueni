...
const getBusiness = (state, ownProps) => property(`businesses.dataById.${ownProps.match.params.id}`)(state)
const getScore = (state, ownProps) => property(`reviews.data.${ownProps.match.params.id}.score`)(state)
